...
object MayakPush {
     ...
     * ОТДЕЛЬНОГО тумблера «быстрые уведомления» решено не заводить — он объяснял бы человеку разницу,
     * которой он не видит (одно и то же сообщение, только раньше), а выключить пуш он и так может там,
     * где уже привык, — в уведомлениях приложения. Причина не только в том, что показать всё равно
     * нечем: Google понижает приоритет пушам приложения, чьи high-priority
