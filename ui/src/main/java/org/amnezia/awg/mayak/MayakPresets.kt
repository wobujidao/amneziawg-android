...
object MayakPresets {
    ...
    /**
     * Полная очистка при СМЕНЕ АККАУНТА: убирает и файл, и память.
     *
     * Пресеты — это настройки конкретного аккаунта (какие приложения ходят мимо туннеля). Выход их
     * не трогал, поэтому следующий вошедший на том же телефоне видел и применял чужие правила —
     * заодно узнавая, какие приложения выбрал предыдущий (разбор 2026-07-27).
     */
